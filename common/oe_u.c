...
void ocall_oe_polling_epoll_create1(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters */
    oe_polling_epoll_create1_args_t* pargs_in =
        (oe_polling_epoll_create1_args_t*)input_buffer;
    oe_polling_epoll_create1_args_t* pargs_out =
        (oe_polling_epoll_create1_args_t*)output_buffer;
    ...
    /* Call user function */
    pargs_out->_retval =
        oe_polling_epoll_create1(pargs_in->flags, pargs_in->err);
...
void ocall_oe_polling_epoll_wait(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters */
    oe_polling_epoll_wait_args_t* pargs_in =
        (oe_polling_epoll_wait_args_t*)input_buffer;
    oe_polling_epoll_wait_args_t* pargs_out =
        (oe_polling_epoll_wait_args_t*)output_buffer;
     ...
     * buffer. */
    OE_SET_OUT_POINTER(
        events, (pargs_in->maxevents * sizeof(struct epoll_event)));
    OE_SET_OUT_POINTER(err, (1 * sizeof(int)));

    /* Call user function */
    pargs_out->_retval = oe_polling_epoll_wait(
        pargs_in->enclaveid,
        pargs_in->epfd,
        pargs_in->events,
        pargs_in->maxevents,
...
void ocall_oe_polling_epoll_ctl_add(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters */
    oe_polling_epoll_ctl_add_args_t* pargs_in =
        (oe_polling_epoll_ctl_add_args_t*)input_buffer;
    oe_polling_epoll_ctl_add_args_t* pargs_out =
        (oe_polling_epoll_ctl_add_args_t*)output_buffer;
    ...
    /* Call user function */
    pargs_out->_retval = oe_polling_epoll_ctl_add(
        pargs_in->epfd,
        pargs_in->fd,
        pargs_in->event_mask,
        pargs_in->list_idx,
        pargs_in->epoll_enclave_fd,
        pargs_in->err);
...
void ocall_oe_polling_epoll_ctl_del(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters */
    oe_polling_epoll_ctl_del_args_t* pargs_in =
        (oe_polling_epoll_ctl_del_args_t*)input_buffer;
    oe_polling_epoll_ctl_del_args_t* pargs_out =
        (oe_polling_epoll_ctl_del_args_t*)output_buffer;
    ...
    /* Call user function */
    pargs_out->_retval =
        oe_polling_epoll_ctl_del(pargs_in->epfd, pargs_in->fd, pargs_in->err);
...
void ocall_oe_polling_epoll_ctl_mod(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters */
    oe_polling_epoll_ctl_mod_args_t* pargs_in =
        (oe_polling_epoll_ctl_mod_args_t*)input_buffer;
    oe_polling_epoll_ctl_mod_args_t* pargs_out =
        (oe_polling_epoll_ctl_mod_args_t*)output_buffer;
    ...
    /* Call user function */
    pargs_out->_retval = oe_polling_epoll_ctl_mod(
        pargs_in->epfd,
        pargs_in->fd,
        pargs_in->event_mask,
        pargs_in->list_idx,
...
void ocall_oe_polling_epoll_close(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters */
    oe_polling_epoll_close_args_t* pargs_in =
        (oe_polling_epoll_close_args_t*)input_buffer;
    oe_polling_epoll_close_args_t* pargs_out =
        (oe_polling_epoll_close_args_t*)output_buffer;
    ...
    /* Call user function */
    pargs_out->_retval = oe_polling_epoll_close(pargs_in->fd, pargs_in->err);
...
void ocall_oe_polling_shutdown_device(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters */
    oe_polling_shutdown_device_args_t* pargs_in =
        (oe_polling_shutdown_device_args_t*)input_buffer;
    oe_polling_shutdown_device_args_t* pargs_out =
        (oe_polling_shutdown_device_args_t*)output_buffer;
    ...
    /* Call user function */
    pargs_out->_retval =
        oe_polling_shutdown_device(pargs_in->fd, pargs_in->err);
...
static oe_ocall_func_t __oe_ocall_function_table[] = {
    ...
    (oe_ocall_func_t)ocall_oe_polling_epoll_create1,
    (oe_ocall_func_t)ocall_oe_polling_epoll_wait,
    (oe_ocall_func_t)ocall_oe_polling_epoll_ctl_add,
    (oe_ocall_func_t)ocall_oe_polling_epoll_ctl_del,
